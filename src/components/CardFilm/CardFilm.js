                        ...
                        <div className="py-3 px-1 relative bg-gray-200">
                            ...
                            <div className="opacity-0 group-hover:opacity-100 absolute bottom-0 left-0 h-full w-full rounded-b-xl bg-gray-200 transform transition duration-500">
                                <div className='h-full relative'>
                                    <button
                                        onClick={() => history.push(`/chitietphim/${film.maPhim}`)}
                                        className="absolute right-1/2 bottom-1/2 translate-y-1/2 translate-x-1/2 text-center rounded-lg px-2 py-1 bg-indigo-600  text-white font-medium text-base hover:bg-indigo-700">
                                        Xem chi tiết
                                    </button>
                                </div>
                                {/* <button onClick={() => history.push(`/checkout/`)} className="absolute bottom-2.5 right-2.5 text-center rounded-lg px-2 py-1 bg-indigo-600 text-white font-medium text-base hover:bg-indigo-700">Đặt vé</button> */}
                            </div>
                        </div>
                    </div>
                </div>
